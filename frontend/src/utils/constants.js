...
export const services = [
  ...
  },
  {
    ...
    icon: <GiDiamondHard />,
    title: 'vision',
    text: 'Our vision is to take Khushboo Jwellery to greater heights, by providing our customers best in class service.',
  },
  {
    id: 3,
    icon: <GiStabbedNote />,
    title: 'history',
    text: `Khushboo Jwellery was started in December'21 with an initial aim to provide the best in class services to our customers.`,
  },
];
